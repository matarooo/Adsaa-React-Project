...
export default function Navbar() {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center bg-[#161616] rounded-full p-1.5 border border-[#262626]">
            <NavLink className="px-5 py-2.5 rounded-full text-sm font-medium transition-all duration-300 bg-linear-to-r from-orange-500 to-orange-600 text-white" to="/" data-discover="true" aria-current="page">الرئيسية</NavLink><NavLink className="px-5 py-2.5 rounded-full text-sm font-medium transition-all duration-300 text-neutral-400 hover:text-white" to="/blog" data-discover="true">المدونة</NavLink><NavLink className="px-5 py-2.5 rounded-full text-sm font-medium transition-all duration-300 text-neutral-400 hover:text-white" to="/about" data-discover="true">من نحن</NavLink>
        </div>
        </div>
